    ...
    <div class="col-lg-8">
      <div class="card shadow-sm border-0">
        <div class="card-body">
          ...
          <p class="mb-3">Asesmen ini terdiri dari 42 pernyataan aktivitas yang harus kamu nilai berdasarkan seberapa suka kamu dalam menjalani aktivitas tersebut, dengan skala: (1) tidak suka, (2) kurang suka, (3) netral, (4) agak suka, (5) suka. 
          Asesmen ini memerlukan waktu sekitar lima hingga sepuluh menit untuk diselesaikan.</p>
          <h5 class="fw-bold mb-2 text-success">Partisipasi</h5>
          <p class="mb-0">Asesmen ini dapat digunakan sebagai eksplorasi, saran dan bahan pertimbangan rekomendasi karier oleh konselor. Jawaban Kamu akan disimpan dan digunakan untuk keperluan konseling dan pengembangan asesmen.</p>
        </div>
      </div>
    </div>
  </div>
