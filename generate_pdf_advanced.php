...
<body>
    <div class="alert-success">
        ...
        <p style="margin: 0;">Berdasarkan hasil tes, tipe kepribadian Anda adalah <strong>' . htmlspecialchars($result_personality) . '</strong></p>
          ...
          <table style="width: 100%; height: 250px; border-collapse: collapse; margin-top: 20px;">
              <tr style="height: 200px; vertical-align: bottom;">';
                  ...
                  foreach ($personalityTypes as $code => $name) {
                      ...
                      $html .= '<div style="position: relative; display: inline-block; width: 80%; max-width: 60px;">';
